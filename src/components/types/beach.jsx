...
const Beach=()=>{
    ...
    useEffect(()=>{
        const url = 'https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=e754694a18d1a6527fbd0e1e44abeecc&tags=beaches&format=json&nojsoncallback=1';
